...
def calculateSpecularAlbedo(path, form) :
    ...
    im = Image.fromarray(specular_max.astype('uint8'), 'L')
    plt.imshow(im, cmap='gray', vmin=0, vmax=255)
    plt.show()    
...
if __name__ == "__main__":
    ...
    form = ".png"#".bmp"
    path = "/home/givenone/Desktop/cycle_test_revised_9_png/"
        
    vd = generate_viewing_direction(path, form, focalLength = 0.05, sensor = (0.025, 0.024))
